...
class Cp2kNamd(MakefilePackage, CMakePackage, CudaPackage, ROCmPackage):
    ...
    patch(
        "cp2k-2026.1-nac-code.patch",
        when="@2026.1 +namd"
    )

    requires("@2026.1", when="+namd", msg="Variant 'namd' is only supported in cp2k@2026.1")
